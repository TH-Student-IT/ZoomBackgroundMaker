...
const DEPARTMENT_MAP = {
  IT学部: {
    1: "IH: 高度情報学科 高度ITコース",
    2: "IW: 高度情報学科 WEB開発コース",
    3: "IA: 高度情報学科 AIシステム開発コース",
    4: "IH: 高度情報学科 高度システムエンジニア専攻",
    5: "IN: 高度情報学科 IoTネットワーク専攻",
    6: "IS: 高度情報学科 サイバーセキュリティ専攻",
    7: "IW: 高度情報学科 WEB開発エンジニア専攻",
    8: "IM: 高度情報学科 スマートフォンアプリ開発専攻",
    9: "ID: 高度情報学科 WEBデザイナー専攻",
    10: "IA: 高度情報学科 AIエンジニア専攻",
    11: "IR: 高度情報学科 次世代ロボティクス専攻",
    12: "IV: 高度情報学科 データサイエンス専攻",
  },
  ゲーム学部: {
    1: "AT: ゲーム4年制学科 ゲーム制作コース",
    2: "AP: ゲーム4年制学科 ゲーム企画コース",
    3: "AD: ゲーム4年制学科 ゲームデザインコース",
    4: "AT: ゲーム4年制学科 VR・3Dゲームプログラマー専攻",
    5: "AO: ゲーム4年制学科 オンラインゲームプログラマー専攻",
    6: "AM: ゲーム4年制学科 スマートフォンゲームプログラマー専攻",
    7: "AP: ゲーム4年制学科 ゲームプランナー専攻",
    8: "AS: ゲーム4年制学科 ゲームシナリオライター専攻",
    9: "AR: ゲーム4年制学科 ゲームディレクター専攻",
    10: "AD: ゲーム4年制学科 ゲームデザイナー専攻",
    11: "AC: ゲーム4年制学科 ゲーム3Dキャラクターデザイナー専攻",
    12: "AF: ゲーム4年制学科 ゲームスマートフォンゲームデザイナー専攻",
  },
  CG学部: {
    1: "CT: CG・デザイン・アニメ四年制学科 CG映像コース",
    2: "CG: CG・デザイン・アニメ四年制学科 グラフィックデザインコース",
    3: "CI: CG・デザイン・アニメ四年制学科 イラストコース",
    4: "CA: CG・デザイン・アニメ四年制学科 アニメーションコース",
    5: "CT: CG・デザイン・アニメ四年制学科 3DCGクリエイター専攻",
    6: "CV: CG・デザイン・アニメ四年制学科 VFXアーティスト専攻",
    7: "CG: CG・デザイン・アニメ四年制学科 CGデザイナー専攻",
    8: "CI: CG・デザイン・アニメ四年制学科 イラストレーター専攻",
    9: "CA: CG・デザイン・アニメ四年制学科 アニメーター専攻",
    10: "CD: CG・デザイン・アニメ四年制学科 デジタル作画専攻",
  },
  カーデザイン学部: {
    1: "VD: カーデザイン学科 カーデザインコース",
    2: "VM: カーデザイン学科 カーモデラーコース",
    3: "VD: カーデザイン学科 カーデザイナー専攻",
    4: "VN:カーデザイン学科 次世代モビリティ開発専攻",
    5: "VM: カーデザイン学科 カーモデラー専攻",
  },
  ミュージック学部: {
    1: "SE: ミュージック学科 サウンドエンジニアコース",
    2: "SC: ミュージック学科 サウンドクリエイターコース",
    3: "SE: ミュージック学科 サウンドエンジニア専攻",
    4: "SC: ミュージック学科 サウンドクリエイター専攻",
    5: "SG: ミュージック学科 ゲームミュージック専攻",
  },
  ゲーム学部2年生課程: {
    1: "GP: ゲーム学科 2年制課程",
    2: "GP: ゲーム学科 ゲームプログラム専攻",
    3: "GC: ゲーム学科 キャラクターデザイン専攻",
  },
  CG学部2年制課程: {
    1: "DG: CG学科 2年制課程",
    2: "DA: CG学科 CGアニメーション専攻",
    3: "DG: CG学科 CGデザイン専攻",
  },
  WEB学部: {
    1: "PW: WEB学科 2年制課程",
    2: "PW: WEB学科 WEBプログラム専攻",
    3: "PD: WEB学科 WEBデザイン専攻",
  },
  情報処理学部: {
    1: "PI: 情報処理学科 2年制課程",
    2: "PI: 情報処理学科 情報処理プログラム専攻",
    3: "PS: 情報処理学科 ネットワークセキュリティ専攻",
  },
  ミュージック学部2年制課程: {
    1: "MC: ミュージック学科 2年制課程",
    2: "MC: ミュージック学科 コンピュータミュージック専攻",
    3: "MR: ミュージック学科 PA・レコーディング専攻",
  },
};
...
function renderCanvas(ctx, canvas, scale = 1) {
  ...
  if (inputMode === "select") {
    ...
    departmentString = `${courseName.split(": ")[1]} ${grade}年`;
  } else {
    // カスタム入力モードの場合
